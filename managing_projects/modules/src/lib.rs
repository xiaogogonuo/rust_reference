...
////////////////////////////////////////////////////////////////////////////////
mod manage_modules {
    //! Modules work mechanism
    //!
    //! * Start from the crate root: When compiling a crate, the compiler first looks in the crate
    //! root file(usually src/lib.rs for a library crate or src/main.rs for a binary crate) for code
    //! to compile.
    //! * Declaring modules: In the crate root file, you can declare new modules; you declare a
    //! garden module with `mod garden;` compiler will look for the module’s code in these places:
    //!   * Inline, within curly brackets that replace the semicolon following `mod garden`
    //!   * In the file src/garden.rs
    //!   * In the file src/garden/mod.rs
    //! * Declaring submodules: In any file other than the crate root, you can declare submodules.
    //! example, you might declare `mod vegetables;` in src/garden.rs. The compiler will look for
    ...
    //! that module from anywhere else in that same crate, as long as the privacy rules allow, using
    //! the path to the code. For example, an `Asparagus` type in the garden vegetables module would
    ...
    //! repetition of long paths. Any scope can refer to `crate::garden::vegetables::Asparagus`,
    //! you can create a shortcut with `use crate::garden::vegetables::Asparagus;` and from then
